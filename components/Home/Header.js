      ...
      <div className="hidden md:basis-1/2 md:w-full      md:flex">
        <div className="flex w-full md:basis-1/4 justify-center items-center ">
          ...
          <div className="p-1  ">
            <p>
              <a
                className="text-gray-300 xxs:text-sm text-sm"
                href="tel:+7695864558"
              >
                +769 586 4558
              </a>
        ...
        <div className="md:w-full md:ml-2 md:basis-2/4 ">
          <a
            className="text-gray-400 md:border font-bold md:border-gray-600 md:pl-6 md:pr-6 md:pt-2 md:pb-3 md:rounded-full"
            href="#"
          >
